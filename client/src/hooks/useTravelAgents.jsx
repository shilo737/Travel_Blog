...
import { addTravelAgents, deleteTravelAgents, getAllTravelAgents } from '../redux/features/travelAgentSlice';


const useTravelAgents = () => {
const {travelAgents,loading,error} = useSelector((store)=>store.travelAgentReducer)
